	...
	if (a1 == 1)
	{
		...
		if (a1 == 0)
		{
			...
			if (a1 == 2)
			{
				...
				if (a1 == 3)
				{
					cout << "Введите 1 число" << endl; cin >> b1;
					cout << "Введите 2 число" << endl; cin >> c1;
					if (b1 <= c1)
					{
					...
					{
						s1 = b1 - c1; cout << "Разность двух чисел = " << s1 << endl;
					}
				}
				else
					if (a1 == 4)
					{
						...
						{
							s1 = b1 / c1; cout << "Частное двух чисел = " << s1 << endl;
						}
					}
					else
						if (a1 == 5)
						{
							...
							{
								s1 = b1 % c1; cout << "Остаток от деления = " << s1 << endl;
							}
						}
